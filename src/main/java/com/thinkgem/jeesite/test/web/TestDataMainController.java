...
public class TestDataMainController extends BaseController {
	...
	public String list(TestDataMain testDataMain, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
	...
	public String form(TestDataMain testDataMain, ModelMap model) {
		model.put("testDataMain", testDataMain);
		return "jeesite/test/testDataMainForm";
	}

	@RequiresPermissions("test:testDataMain:edit")
	@RequestMapping(value = "save")
	public String save(TestDataMain testDataMain, ModelMap model, RedirectAttributes redirectAttributes) {
